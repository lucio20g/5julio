...
function preload() {
  ...
  imgs[0] = loadImage("IMAGENES/mazo_azul.png");
  imgs[1] = loadImage("IMAGENES/mazo_rojo.png");
  imgs[2] = loadImage("IMAGENES/mesa_tejo3.png");
  imgs[3] = loadImage("IMAGENES/disco8.png");
  imgs[4] = loadImage("IMAGENES/mazo-set1.png");
  imgs[5] = loadImage("IMAGENES/mazo-set2.png");
  imgs[6] = loadImage("IMAGENES/mesadetejo.jpg");
  imgs[7] = loadImage("IMAGENES/disco3.png");
  imgs[8] = loadImage("IMAGENES/mazoazul.png");
  imgs[9] = loadImage("IMAGENES/mazorojo.png");
  imgs[10] = loadImage("IMAGENES/mesadetejo2.png");
  imgs[11] = loadImage("IMAGENES/disco1.png");
  fondo = loadImage("IMAGENES/win1.jpeg");
  fondo2 = loadImage("IMAGENES/win2.jpeg");
